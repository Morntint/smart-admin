...
<script setup lang="ts">
  ...
  import LogSearch, { type OperationLogSearchParams } from '../../log/modules/log-search.vue'
  import LogDetailDialog from '../../log/modules/log-detail-dialog.vue'
