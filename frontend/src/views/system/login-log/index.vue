      ...
      >
        <template #left>
          <ElSpace wrap>
            ...
            >
              <template #reference>
                <ElButton type="warning" v-ripple v-auth="'system:log:loginDel'">清理日志</ElButton>
              </template>
            </ElPopconfirm>
          </ElSpace>
        </template>
...
<script setup lang="ts">
  ...
  import LoginLogSearch, { type LoginLogSearchParams } from './modules/login-log-search.vue'
